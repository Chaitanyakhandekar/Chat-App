...
function Message({ msg, key }) {
  ...
  return (
    ...
    <div
     ref={messageRef}
     key={key} className={`ml-10 mt-10 w-fit  max-w-[70%] min-w-20 h-auto   mt-20 ${msg.sender === context.user._id ? "bg-blue-400" : "bg-green-400"} text-black p-3  flex flex-col  rounded-md relative`}>
