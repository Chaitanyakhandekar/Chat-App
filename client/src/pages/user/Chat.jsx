    ...
    return (
        <>
            ...
            <div className="flex h-[100dvh] bg-[#0a0b0f] text-[#f1f2f7] overflow-hidden">
                ...
                {/* ── ICON RAIL (far left) ── */}
                <div className="hidden md:flex flex-col items-center gap-1.5 w-[62px] min-w-[62px] h-screen bg-[#0a0b0f] border-r border-white/[0.05] pt-5 pb-4 z-30">
                    {/* Brand mark */}
                    <div
                    ...
                    <NavIconBtn icon={Users} panel="newGroup" tooltip="Groups" />
